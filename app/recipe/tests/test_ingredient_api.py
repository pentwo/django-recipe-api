...
class PrivateIngredientApiTests(TestCase):
    ...
    def test_ingredients_limited_to_user(self):
        ...
        user2 = create_user("test2@example.com", "Testpass123")
    ...
    def test_ingredient_update(self):
        ...
        ingredient = Ingredient.objects.create(user=self.user, name="Citrus")
    ...
    def test_ingredient_assigned_to_recipes(self):
        ...
        recipe = Recipe.objects.create(
            title="Apple pie", time_minutes=5, price="10.00", user=self.user
        )
    ...
    def test_filter_ingredient_unique(self):
        ...
        r1 = Recipe.objects.create(
            title="Recipe 1", time_minutes=5, price=Decimal(10.00), user=self.user
        )
