...
# for test to quickly create a recipe (with default values)
...
class PrivateRecipeApiTests(TestCase):
    ...
    def test_recipes_limited_to_user(self):
        """Test retrieving recipes owned by the authenticated user."""
    ...
    def test_create_recipe(self):
        ...
        payload = {
            ...
            "time_minutes": 30,
            "price": Decimal(5.25),
            "link": "http://example.com/chocolate-cheesecake.pdf",
        }
    ...
    def test_update_user_return_error(self):
        """Test that updating the user is not allowed."""
    ...
    def test_delete_recipe(self):
        ...
        url = detail_url(recipe.id)
        res = self.client.delete(url)  # call delete method

        self.assertEqual(res.status_code, status.HTTP_204_NO_CONTENT)
        self.assertFalse(Recipe.objects.filter(id=recipe.id).exists())

    def test_delete_recipe_owned_by_other_user(self):
        new_user = create_user(email="new_user@example.com", password="Testpass123")
    ...
    def test_create_recipe_with_new_tag(self):
        ...
        payload = {
            ...
            "time_minutes": 15,
            "price": Decimal(10.00),
            "tags": [{"name": "New tag"}, {"name": "Another tag"}],
        }
    ...
    def test_create_recipe_with_existing_tag(self):
        ...
        payload = {
            ...
            "time_minutes": 15,
            "price": Decimal(10.00),
            "tags": [{"name": "Indian"}, {"name": "Another tag"}],
        }
    ...
    def test_create_tag_on_update(self):
        ...
        recipe = create_recipe(user=self.user)  # recipe without tags

        payload = {"title": "New title", "tags": [{"name": "New tag"}]}
        url = detail_url(recipe.id)
    ...
    def test_update_recipe_assign_tag(self):
        ...
        new_recipe = create_recipe(user=self.user)  # recipe without tags
        new_recipe.tags.add(tag_breakfast)

        tag_lunch = Tag.objects.create(user=self.user, name="Lunch")
        payload = {"tags": [{"name": "Lunch"}]}  # replace "breakfast" with "lunch"
    ...
    def test_create_recipe_with_new_ingredient(self):
        ...
        payload = {
            ...
            "time_minutes": 15,
            "price": Decimal(10.00),
            "ingredients": [{"name": "New ingredient"}, {"name": "Another ingredient"}],
        }
    ...
    def test_create_recipe_with_existing_ingredient(self):
        ...
        payload = {
            ...
            "time_minutes": 15,
            "price": Decimal(10.00),
            "ingredients": [{"name": "Salt"}, {"name": "Another ingredient"}],
        }
    ...
    def test_update_recipe_assign_ingredient(self):
        ...
        new_recipe.ingredients.add(ingredient1)
        ...
        self.assertIn(ingredient2, new_recipe.ingredients.all())
        self.assertNotIn(ingredient1, new_recipe.ingredients.all())
    ...
    def test_filter_by_ingredients(self):
        ...
        in2 = Ingredient.objects.create(user=self.user, name="Ingredient 3")
...
class ImageUploadTests(TestCase):
    ...
    def test_upload_image_to_recipe(self):
        ...
        with tempfile.NamedTemporaryFile(suffix=".jpg") as image_file:
            img = Image.new("RGB", (10, 10))  # pillow created image
